...
<title>SBM - Free HTML5 Template</title>
			...
			<div class="col-md-4 ">
				<div class="navbar-header">
					    <button type="button" class="navbar-toggle menu-button" data-toggle="collapse" data-target="#myNavbar">
      					...
      					<a class="navbar-brand logo" href="#">SBM Coaching</a>
    			</div>
			</div>
			<div class="col-md-8">
				<nav class="collapse navbar-collapse" id="myNavbar" role="navigation">
					<ul class="nav navbar-nav navbar-right menu">
							...
							<li><a href="#section2" class="page-scroll">Teacher info</a></li>
							<li><a href="#work" class="page-scroll">Class live</a></li>
		...
		<div class="col-md-12 backg">
			<div class="col-md-4 col-md-offset-4 inner col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3">
				<div class="text-box">
                    ...
                    <h2>SBM</h2>
                    <h3>HELLO SBM</h3>
                    <p>By <span><a href="http://www.html5layouts.com">SBM-Info</a></span></p>
                    <p><a href="pages/email.jsp" class="link-button">Tell Me Something</a></p>
                    <p class="h3">Contract: 01740827226</p>
				</div>
  			</div>
		</div>
		<div class="col-md-12 some-notes">
			<div class="title">
                <h2>Welcome To SBM</h2>
            </div>
            <div class="desc">
                <p>SBM is most popular case <a href="http://www.html5templates">HTML5 Layouts</a>. You can use this template for personal as well as commercial purpose but you have to give us a credit link in footer.</p>
            </div>
		</div>
	</div>
</div>
	...
	<div class="container">
		<div class="row" id="starts">
			<div class="col-md-12 col-sm-12 col-xs-12 work-list">
				<h2 class="text-center portfolio-text">Class live</h2>
				...
				<div class="col-md-4 col-sm-6 col-xs-12 work-space">
					<a href="images/img1.jpg" data-lightbox="image-1">
                		<div class="featured-img">
				...
				<div class="col-md-4 col-sm-6 col-xs-12 work-space">
					<a href="images/img.jpg" data-lightbox="image-1">
                		<div class="featured-img">
...
<div class="container-fluid footer">
    ...
    <script>
      function initialize() {
        ...
        var mapOptions = {
          center: new google.maps.LatLng(23.7316238,90.357475,13),
          zoom: 8,
